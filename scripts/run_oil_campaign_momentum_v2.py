#!/usr/bin/env python3
"""Run Oil Campaign Momentum v2 from the standalone suite."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Oil Campaign Momentum v2 from this suite")
    parser.add_argument("--market", default="brent", help="Oil campaign v2 market profile name")
...
def main() -> int:
    ...
    profile_file = ROOT / "config" / "oil_campaign_momentum_v2" / f"{args.market}.json"
    ...
    paths = make_run_paths(
        strategy_slug="oil_campaign_momentum_v2",
    ...
    bot_config.update(
        {
            ...
            "features_jsonl": str(paths["run_dir"] / "features.jsonl"),
    ...
    write_manifest(
        ...
        strategy_name="Oil Campaign Momentum v2",
        market_name=profile_config["market_name"],
        account_name=args.account,
        account_file=account_file,
        profile_file=profile_file,
        bot_script="oil_campaign_momentum_v2_bot.py",
        dashboard_script="oil_campaign_momentum_v2_dashboard.py",
    ...
    return run_managed(
        ...
        title=f"Starting Oil Campaign Momentum v2 for {profile_config['market_name']}",
    )
