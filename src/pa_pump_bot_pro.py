#!/usr/bin/env python3
"""Paper-trading rare-event momentum engine using websocket BBO, l2Book, and trades."""
...
from pa_pump_pro_core import ProMomentumBot
...
DEFAULT_IMPULSE_WINDOW_SECONDS = 30.0
DEFAULT_BREAKOUT_LOOKBACK_SECONDS = 300.0
DEFAULT_VOLATILITY_LOOKBACK_SECONDS = 300.0
DEFAULT_FLOW_WINDOW_SECONDS = 30.0
DEFAULT_MIN_IMPULSE_BPS = 30.0
DEFAULT_VOLATILITY_MULTIPLIER = 2.0
DEFAULT_BREAKOUT_BUFFER_BPS = 2.0
DEFAULT_FLOW_IMBALANCE_MIN = 0.20
DEFAULT_BOOK_IMBALANCE_MIN = 0.12
DEFAULT_MIN_TRADE_COUNT = 5
DEFAULT_DEPTH_LEVELS = 3
DEFAULT_MAX_SPREAD_BPS = 6.0
DEFAULT_MAX_QUOTE_AGE_MS = 1200
DEFAULT_QUOTE_GAP_WARN_MS = 2500
DEFAULT_RECONNECT_GAP_MS = 30000
DEFAULT_INITIAL_STOP_MIN_BPS = 12.0
DEFAULT_INITIAL_STOP_VOL_MULTIPLIER = 1.35
DEFAULT_TRAIL_MIN_BPS = 10.0
DEFAULT_TRAIL_VOL_MULTIPLIER = 1.75
DEFAULT_TRAIL_ARM_R = 0.75
DEFAULT_BREAK_EVEN_LOCK_R = 1.0
DEFAULT_FAILURE_HOLD_SECONDS = 20.0
DEFAULT_FAILURE_MIN_FOLLOWTHROUGH_BPS = 8.0
...
DEFAULT_MAX_TRADES_PER_HOUR = 2
DEFAULT_MIN_HOLD_SECONDS = 0.0
DEFAULT_EVENTS_JSONL = "logs/pro_events.jsonl"
DEFAULT_SAMPLES_JSONL = "logs/pro_samples.jsonl"
DEFAULT_TRADES_CSV = "logs/pro_trades.csv"
DEFAULT_REPORT_DIR = "logs/pro_reports"
DEFAULT_API_URL = (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Paper-trading rare-event momentum engine for Hyperliquid",
    )
    ...
    parser.add_argument("--min-impulse-bps", type=float, default=DEFAULT_MIN_IMPULSE_BPS)
    parser.add_argument(
    ...
    parser.add_argument(
        "--flow-imbalance-min",
        type=float,
        default=DEFAULT_FLOW_IMBALANCE_MIN,
        help="Minimum signed aggressive flow imbalance ratio needed to confirm entry.",
    )
    parser.add_argument(
        "--book-imbalance-min",
        type=float,
        default=DEFAULT_BOOK_IMBALANCE_MIN,
        help="Minimum signed top-of-book imbalance ratio needed to confirm entry.",
    )
    ...
    parser.add_argument(
        "--initial-stop-min-bps",
        type=float,
        default=DEFAULT_INITIAL_STOP_MIN_BPS,
    )
    parser.add_argument(
