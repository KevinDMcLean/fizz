...
DASHBOARD_TARGETS: List[Dict[str, str]] = [
    ...
    },
    {
        ...
        "scope": "Choosy live profile. Oil momentum code affects only the oil campaign strategy, not Kevin.",
    ...
    },
    {
        ...
        "summary_url": "http://127.0.0.1:8803/api/summary",
        "umbrella": "momentum",
        "family": "Oil Momentum - Medium",
        "scope": "Relaxed learning profile. Oil momentum code affects only the oil campaign strategy, not Kevin.",
        "fallback_market": "BRENTOIL",
    },
    {
        "slug": "oil-wti-medium",
        ...
        "summary_url": "http://127.0.0.1:8804/api/summary",
        "umbrella": "momentum",
        "family": "Oil Momentum - Medium",
        "scope": "Relaxed learning profile. Oil momentum code affects only the oil campaign strategy, not Kevin.",
        "fallback_market": "CL",
